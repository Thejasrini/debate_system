...
def build_fast_benchmark():
    print("==================================================")
    print("LEXAGENT BENCHMARK EXPANSION PIPELINE")
    print("==================================================\n")

    raw_cases_collected = 0
    consumer_relevant_cases = []

    # 1. Load Local Primary Landmark Precedents (Supreme Court / NCDRC)
    print("📥 Loading Primary Supreme Court & NCDRC Judgments...")
    if os.path.exists("./data/consumer_protection_judgments.json"):
        ...
        print(f"   -> Retained {len(local_judgments)} official landmark precedents.\n")

    # 2. Load Legal Triage Consumer Cases
    ...
    # 3. Load Basic Legal QA Consumer Pairs
    print("📥 Loading Basic Legal QA Pairs (shruths204/basic-legal-qa-india)...")
    try:
    ...
    # Step 5: Robust Quality Control & Deduplication BEFORE Splitting
    ...
    # Step 6: 80/20 Deterministic Train/RAG/Eval Split (Seed = 42)
    random.seed(42)
