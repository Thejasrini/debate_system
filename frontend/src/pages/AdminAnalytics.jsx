  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "var(--bg)", color: "var(--ink)", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, maxWidth: "1240px", margin: "0 auto", padding: "36px 24px", width: "100%", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", marginBottom: "28px", borderBottom: "1px solid var(--line)", paddingBottom: "14px" }}>
          <button
            onClick={() => handleTabChange("all", "/admin")}
            className="font-mono"
            style={{
              padding: "10px 18px",
              borderRadius: "8px",
              ...
              fontWeight: "bold",
              cursor: "pointer",
              backgroundColor: activeTab === "all" ? "var(--brass)" : "var(--surface)",
              color: activeTab === "all" ? "var(--bg)" : "var(--ink)",
              border: activeTab === "all" ? "1px solid var(--brass)" : "1px solid var(--line)"
            }}
          >
            🏠 Full Admin View
          </button>
          ...
          <button
            onClick={() => handleTabChange("overview", "/admin/overview")}
            className="font-mono"
            style={{
              padding: "10px 18px",
              borderRadius: "8px",
              ...
              fontWeight: "bold",
              cursor: "pointer",
              backgroundColor: activeTab === "overview" ? "var(--brass)" : "var(--surface)",
              color: activeTab === "overview" ? "var(--bg)" : "var(--ink)",
              border: activeTab === "overview" ? "1px solid var(--brass)" : "1px solid var(--line)"
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              fontWeight: "bold",
              cursor: "pointer",
              backgroundColor: activeTab === "users" ? "var(--brass)" : "var(--surface)",
              color: activeTab === "users" ? "var(--bg)" : "var(--ink)",
              border: activeTab === "users" ? "1px solid var(--brass)" : "1px solid var(--line)"
            }}
          >
          ...
          <button
            onClick={() => handleTabChange("cases", "/admin/cases")}
            className="font-mono"
            style={{
              padding: "10px 18px",
              borderRadius: "8px",
              ...
              fontWeight: "bold",
              cursor: "pointer",
              backgroundColor: activeTab === "cases" ? "var(--brass)" : "var(--surface)",
              color: activeTab === "cases" ? "var(--bg)" : "var(--ink)",
              border: activeTab === "cases" ? "1px solid var(--brass)" : "1px solid var(--line)"
            }}
          >
            📜 User Cases & Disputes Log ({casesList.length})
          </button>

          <button
            onClick={() => handleTabChange("feedback", "/admin/feedback")}
            className="font-mono"
            style={{
              padding: "10px 18px",
              borderRadius: "8px",
              ...
              fontWeight: "bold",
              cursor: "pointer",
              backgroundColor: activeTab === "feedback" ? "var(--brass)" : "var(--surface)",
              color: activeTab === "feedback" ? "var(--bg)" : "var(--ink)",
              border: activeTab === "feedback" ? "1px solid var(--brass)" : "1px solid var(--line)"
            }}
          >
            💬 User Feedback Log ({feedbackList.length})
          </button>
        </div>
